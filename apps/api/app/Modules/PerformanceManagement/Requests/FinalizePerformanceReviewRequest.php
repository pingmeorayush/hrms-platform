...
class FinalizePerformanceReviewRequest extends FormRequest
{
    ...
    {
        return [
            'final_rating' => ['required', 'numeric', 'gt:0'],
            'summary' => ['required', 'string'],
            'employee_visible_summary' => ['required', 'string'],
            'recommendation' => ['nullable', 'string', 'max:128'],
        ];
    }
}
