 ...
 * @property array<int, array<string, mixed>> $approved_fields
 * @property array<int, array<string, mixed>>|null $approved_filters
 * @property array<int, array<string, mixed>>|null $drilldown_paths
 * @property array<string, mixed> $masking_posture
...
class ReportDataset extends Model
{
    ...
    protected function casts(): array
    {
        return [
            ...
            'drilldown_paths' => 'array',
            'masking_posture' => 'array',
